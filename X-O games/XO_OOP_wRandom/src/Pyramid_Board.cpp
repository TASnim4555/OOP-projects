...
#include "iostream"
Pyramid_Tic_Tac::Pyramid_Tic_Tac() {
    n_rows = 3;
    n_cols = 5;
    ...
    for(int i=0;i<n_rows;i++){
        ...
        for(int j=0;j<n_cols;j++){
            if((i==0&&j==2)||(i==1&&(j==1||j==2||j==3))||(i==2&&(j==0||j==1||j==2||j==3||j==4))){
                board[i][j]='0';
            }
            else {
                board[i][j]=' ';
...
bool Pyramid_Tic_Tac::update_board(int x, int y, char symbol) {
...
void Pyramid_Tic_Tac::display_board() {
...
bool Pyramid_Tic_Tac::is_winner() {

            if((board[0][2]==board[1][1])&&(board[1][1]==board[2][0])&&(board[0][2]==board[2][0])&&((board[0][2]=='X')||board[0][2]=='O')){
                return true;
            }
            else if((board[2][2]==board[2][3])&&(board[2][3]==board[2][4])&&(board[2][2]==board[2][4])&&((board[2][2]=='X')||board[2][2]=='O')){
                return true;
            }
            else if((board[0][2]==board[1][2])&&(board[1][2]==board[2][2])&&(board[0][2]==board[2][2])&&((board[0][2]=='X')||board[0][2]=='O')){
                return true;
            }
            else if((board[2][0]==board[2][1])&&(board[2][1]==board[2][2])&&(board[2][0]==board[2][2])&&((board[2][2]=='X')||board[2][2]=='O')){
                return true;
            }
            else if((board[2][2]==board[2][3])&&(board[2][3]==board[2][4])&&(board[2][2]==board[2][4])&&((board[2][2]=='X')||board[2][2]=='O')){
                return true;
            }
            else if((board[1][1]==board[1][2])&&(board[1][2]==board[1][3])&&(board[1][1]==board[1][3])&&((board[1][1]=='X')||board[1][1]=='O')){
                return true;
            }
            else return false;
...
bool Pyramid_Tic_Tac::game_is_over() {
    if(n_moves>9){
        return true;
    }
    else return false;
